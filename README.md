...
<p align="left">
  ...
  <span style="display:inline-flex; align-items:center; background-color:#2d4a49; border-radius:4px; background-color:orange; padding:0px 10px 40px 10px; height:28px; margin-right:4px;">
    ...
    <span style="color:white; font-size:13px; font-weight:bold; margin-bottom:10px;">LangGraph</span>
  </span>
